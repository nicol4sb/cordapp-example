 ...
 */
public class NDAEditionFlow {
    @InitiatingFlow
    @StartableByRPC
    public static class Initiator extends FlowLogic<SignedTransaction> {
        
        private final String ndaRequestText;
        private final NDAContractState previousNDAContractState;

        private final Step GENERATING_TRANSACTION = new Step("Generating transaction based on new NDA edition Request.");
        ...
        public Initiator(String ndaRequestText, NDAContractState previousNDAContractState) {
            this.ndaRequestText= ndaRequestText;
            this.previousNDAContractState = previousNDAContractState;
        }
        ...
        public SignedTransaction call() throws FlowException {
            ...
            NDAContractState ndaContractState = new NDAContractState(ndaRequestText, getServiceHub().getMyInfo().getLegalIdentities().get(0), previousNDAContractState.getNdaRequestRecipient());
            ...
            FlowSession otherPartySession = initiateFlow(previousNDAContractState.getNdaRequestRecipient());
